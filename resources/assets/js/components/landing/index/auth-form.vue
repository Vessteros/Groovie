                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form id="contact-form" class="contact">
                            ...
                            <input value="Зарегистрироваться" id="submit-button" class="contact-submit"
                                   @click="register()">
            ...
            register() {
                ...
                switch (true) {
                    ...
                    default:
                        axios({
                            method: 'post',
                            url: 'http://vessteros.beget.tech/api/register',
                            headers: {
        ...
        mounted() {
            ...
            !function (a, b, c, d) {
                ...
                e.Defaults = {
                    ...
                    var c = this.current(), d = null, e = a - this.relative(c), f = (e > 0) - (0 > e),
